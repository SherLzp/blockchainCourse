...
//Does the tag show intermediate processes
#define TAG 0

//Define logical right shift algorithm
#define SHR(x, n) (((x) >> (n)))
//Defining a circular right shift algorithm
#define ROTR(x, n) (((x) >> (n)) | ((x) << ((sizeof(x) << 3) - (n))))

//Define logical operation algorithm
