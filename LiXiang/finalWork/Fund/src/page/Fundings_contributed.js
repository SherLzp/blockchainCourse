import { Layout, Menu, Table, Typography,Button} from 'antd';
...
class Fundings_contributed extends Component {
    state = {
        collapsed: false,
        mode: 'inline',
    };
    ...
    componentDidMount(){
        this.setState({
          columns: [
            { title: '标题', dataIndex: 'FundingTitle',key: 'FundingTitle',},
            { title: '目标金额', dataIndex: 'FundingTarget_eth', key: 'FundingTarget_eth' },
            { title: '目前金额', dataIndex: 'FundingTotal_eth', key: 'FundingTotal_eth' },            
            { title: '你的出资', dataIndex: 'FundingContribution_eth', key: 'FundingContribution_eth'},
            { title: '截止时间', dataIndex: 'FundingDeadline', key: 'FundingDeadline' },
            { title: '当前状态', 
              dataIndex: 'FundingState', 
              key: 'FundingState',
              render: (FundingState) => {
                if (FundingState === "Ongoing") return '正在进行';
                else return '筹资结束';
                },
            },  
            {
...
export default Fundings_contributed;
