...
import {Button, Card, Layout, List, Drawer, InputNumber, Tag, Form, Divider, Col, Row, Statistic, Progress, Modal, Input} from "antd";
...
class MyCrowdFund_1 extends Component {
    constructor() {
        super();
        this.state = {
            dataSource: [],
    ...
    async fetchData() {
        ...
        console.log(tmp)
        this.setState({dataSource: tmp.init})
    }
    ...
    showChildrenDrawer2 = (e, item) => {
        this.setState({
            childrenDrawer2: item.index,
        });
    };
    ...
    onSubmit2 = async (values) => {
        await newApply(values.index, values.amount, values.reason)
        Modal.success({
            content: '申请成功！',
        });
    };
                    ...
                    renderItem={item => (
                        <List.Item>
                            ...
                            >
                                ...
                                <Button
                                    type="primary"
                                    onClick={e => this.showChildrenDrawer2(e, item)}
                                    disabled={!item.isFinished}
                                >
                                    申请使用
                                </Button>
                                ...
                                <Drawer
                                    ...
                                    visible={this.state.childrenDrawer2 === item.index}
                                >
                                    <Form
                                        hideRequiredMark
                                    ...
                                    >
                                        ...
                                        >
                                            <InputNumber min={1} max={item.amount} />
                                        </Form.Item>
                                        <Form.Item
                                            name="reason"
                                            label="申请理由"
